  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-files-o"></i> 总能耗统计</li>
      </ol>
    </section>
                ...
                <div class="col-md-12">
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="info-box bg-aqua">
                        <div class="info-box-content">
                          <span class="info-box-text">总用水量(吨)</span>
                    ...
                    <div class="col-md-3">
                      <div class="info-box bg-aqua">
                        <div class="info-box-content">
                          <span class="info-box-text">总燃气量(kwh/m2)</span>
                    ...
                    <div class="col-md-3">
                      <div class="info-box bg-aqua">
                        <div class="info-box-content">
                          <span class="info-box-text">总蒸汽量(元)</span>
